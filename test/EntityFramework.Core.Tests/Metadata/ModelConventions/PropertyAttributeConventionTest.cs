...
namespace Microsoft.Data.Entity.Metadata.Conventions
{
    public class PropertyAttributeConventionTest
    {
        ...
        public void NotMappedAttribute_overrides_configuration_from_convention_source()
        {
            ...
            new NotMappedPropertyAttributeConvention().Apply(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Convention));
        ...
        public void NotMappedAttribute_does_not_override_configuration_from_explicit_source()
        {
            ...
            new NotMappedPropertyAttributeConvention().Apply(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Explicit));
